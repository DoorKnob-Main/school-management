            ...
            <div class="row pt-3">
                <div class="col ps-4">
                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white rounded-3" style="background-color: {{ setting('primary_color', '#0d6efd') }};">
                                <h3>Welcome to {{ setting('software_name', 'DoorKnob') }}!</h3>
                                <p><i class="bi bi-emoji-heart-eyes"></i> {{ setting('tagline', 'School Management ERP') }}</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                <h3>Manage school better</h3>
                                <p class="text-end">with <i class="bi bi-lightning"></i> <strong class="text-primary">{{ setting('software_name', 'DoorKnob') }}</strong> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
