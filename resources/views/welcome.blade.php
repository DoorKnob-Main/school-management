        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <h1 class="text-gray-900 dark:text-white"><img src="{{ setting_asset('logo') ?? asset('favicon_io/android-chrome-512x512.png') }}" class="mr-2" height="50px" width="50px"><span style="font-size: 45px; color: {{ setting('primary_color', '#8a6dd9') }};">{{ setting('software_name', 'DoorKnob') }}</span></h1>
